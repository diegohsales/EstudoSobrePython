...
Crie a classe Veiculo contendo ano de fabricação, preco e motor. Crie também o metodo exibir_dados para mostrar 
os dados do Veículo.
Crie a classe Carro, que herda da classe Veiculo e inclua os atributos cor e modelo. Crie também o metodo 
exibir_dados para mostrar os dados do Carro.
Crie a classe Caminhão, que herda da classe Veiculo e inclua o atributos comprimento (em metros). 
...
class Veiculo:
    def __init__(self, ano, preco, motor):
        self.ano = ano
        self.preco = preco
        self.motor = motor              # associação (veiculo possui um motor)
